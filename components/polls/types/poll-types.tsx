// [COMMENTED OUT] 여론조사 기능 비활성화 - 여론조사 타입 및 투표 컴포넌트
// "use client";
//
...
// Placeholder types and stubs to prevent import errors
export type PollType =
  | "binary"
  | "multiple"
  | "checkbox"
...
export function MultiplePoll(_props: BasePollProps) {
  return null;
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function CheckboxPoll(_props: BasePollProps) {
  return null;
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function ScalePoll(_props: Record<string, unknown>) {
  return null;
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function RankingPoll(_props: BasePollProps) {
  return null;
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function YesNoPoll(_props: BasePollProps) {
  return null;
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function PredictionPoll(_props: Record<string, unknown>) {
  return null;
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function FloatingVoteBar(_props: Record<string, unknown>) {
  return null;
}
